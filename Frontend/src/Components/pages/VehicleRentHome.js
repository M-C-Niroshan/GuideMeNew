...
const VehicleRentHome = () => {
  const images = [
    {
      src: Bicycle,
      alt: "Diverse Vehicle Selection",
    },
    {
      src: Bike,
      alt: "Second Image",
    ...
    <div className="Main">
      ...
      <div className="rental-container">
        <div className="rental-services">
          <Card style={{ width: "18rem", height: "100%", backgroundColor: "#4bccbe" }}>
            <Card.Img variant="top" src={Diverse_Vehicle_Selection} style={{ width: "100%", height: "61%" }} />
            <Card.Body>
              <Card.Title>Diverse Vehicle Selection</Card.Title>
              <Card.Text>
                Choose from a range of vehicles, from compact cars for city travel to spacious SUVs for family adventures.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card style={{ width: "18rem", height: "100%", backgroundColor: "#4bccbe" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Our intuitive booking system lets you reserve your vehicle with ease. Select your dates, pick your vehicle, and confirm your booking in minutes.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card style={{ width: "18rem", height: "100%", backgroundColor: "#4bccbe" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Rent a vehicle for as long as you need, with customizable rental durations to fit your schedule.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card style={{ width: "18rem", height: "100%", backgroundColor: "#4bccbe" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Benefit from clear, competitive pricing with no hidden fees. Multiple payment options are available to suit your needs.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card style={{ width: "18rem", height: "100%", backgroundColor: "#4bccbe" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Our dedicated support team is available around the clock to assist with any inquiries or issues you may have.
              </Card.Text>
            </Card.Body>
          </Card>

          <Card style={{ width: "18rem", height: "100%", backgroundColor: "#4bccbe" }}>
            <Card.Img variant="top" src={Convenient_Locations} style={{ width: "100%", height: "65%" }} />
            <Card.Body>
              <Card.Title>Convenient Locations</Card.Title>
              <Card.Text>
                With multiple pickup and drop-off locations, renting a vehicle has never been more convenient.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card style={{ width: "18rem", height: "100%", backgroundColor: "#4bccbe" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Our vehicles are regularly maintained and inspected to ensure your safety and comfort during your rental period.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card style={{ width: "18rem", height: "100%", backgroundColor: "#4bccbe" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Read reviews and ratings from previous customers to help you choose the best vehicle for your needs.
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
...
export default VehicleRentHome;
